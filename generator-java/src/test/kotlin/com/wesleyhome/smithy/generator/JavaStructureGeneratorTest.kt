...
class JavaStructureGeneratorTest {
	...
	fun `generates java record for structure`() {
		...
		val generator = JavaStructureGenerator()
	...
	fun `generates java record with collections`() {
		...
		val shapeId = ShapeId.from("com.wesleyhome#ComplexStructure")
		val shape = model.expectShape(shapeId, StructureShape::class.java)
		val symbolProvider = JavaSymbolProvider(model, "com.wesleyhome.generated")
	...
	fun `generates java record with validation annotations`() {
		...
		val shapeId = ShapeId.from("com.wesleyhome#ValidatedStructure")
		val shape = model.expectShape(shapeId, StructureShape::class.java)
		val symbolProvider = JavaSymbolProvider(model, "com.wesleyhome.generated")
	...
	fun `generates java record with javadoc documentation`() {
		...
		val shapeId = ShapeId.from("com.wesleyhome#DocumentedStructure")
		val shape = model.expectShape(shapeId, StructureShape::class.java)
		val symbolProvider = JavaSymbolProvider(model, "com.wesleyhome.generated")
	...
	fun `generates java record with default values`() {
		...
		val shapeId = ShapeId.from("com.wesleyhome#DefaultStructure")
		val shape = model.expectShape(shapeId, StructureShape::class.java)
		val symbolProvider = JavaSymbolProvider(model, "com.wesleyhome.generated")
