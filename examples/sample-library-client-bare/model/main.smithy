...
@documentation("A nested contact resource for a specific patron.")
resource Contact {
    identifiers: {
        id: String
    }
    read: GetPatronContact
...
@documentation("Retrieves the contact details for a specific patron.")
@http(method: "GET", uri: "/patrons/{id}/contact")
@readonly
@tags(["Patron"])
operation GetPatronContact {
    input: GetPatronContactInput
    output: GetPatronContactOutput
    errors: [
        NotFoundError
        InternalServerError
    ]
...
@documentation("The input shape for GetPatronContact operation.")
@tags(["Patron"])
structure GetPatronContactInput {
    @documentation("The unique identifier of the patron.")
    @required
    @httpLabel
    id: String
...
@documentation("The output shape for GetPatronContact operation.")
@tags(["Patron"])
structure GetPatronContactOutput {
    @documentation("The contact details of the requested patron.")
    @required
